package java_exercise.Chapter16.num8;
...
public class StreamExample {
    public static void main(String[] args) {
        ...
        Map<String, List<String>> groupingMap = list.stream().collect(Collectors.groupingBy(Member::getJob, Collectors.mapping(Member::getName, Collectors.toList())));
